//=============================================================================
// ScienKunScript TitlesScreen (RPG Maker MV 1.5.2)
// SKS_TitleMap.js
...
/*:fr
 * @plugindesc v1.04 Utilise une map en tant qu'écran-titre pour votre jeu.
 ...
 * ===================================CHANGELOGS===================================
 *
 * Version 1.04 : 30/03/2018 : 16h45
 * Modifications dans le script et ajout d'une fonction pour une nouvelle
...
(function () {
    ...
    ScienKun.TitleMap.gotoTitleMap = function () {
    ...
    Scene_Boot.prototype.start = function () {
        ...
        if (DataManager.isBattleTest()) {
            ...
            ScienKun.TitleMap.gotoTitleMap();
        }
